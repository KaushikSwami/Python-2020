...
# ----------> sort
# sort will arrange the value  from lower to higher and alphabetical order
num=[1,5,3,2,7,6,8,10]
num.sort()
print(num)

value=['venkat','ram','kural','jai']
value.sort()
print(value)

# ---------> reverse
mob=['val_1','val_2','val_3','val_4','val_5']
mob.reverse()
print(mob)
print(list(reversed(mob)))

numbers=[12,2,5,16,24,18,13,25]
print(type(numbers))
numbers.sort()
print(numbers)
